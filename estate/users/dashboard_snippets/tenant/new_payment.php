...
<form method="post">
    <input type="hidden" name="post" value="tenant_new_payment" >
        ...
        <th colspan="5" class="text-center">
              ...
              // $success = "Details has been updated!";
                ...
                <tr>
                 ...
                 <tr>
                     <td colspan="4"><button name="tenant_new_payment_btn" type="submit" class="btn btn-sm tenant_color ">
                            <i class="fa fa-plus-square fa-fw"></i> Submit Payment
                    </button>
                    </td>
