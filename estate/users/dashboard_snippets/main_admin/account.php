...
<!--   // $staff = <<<STAFF-->
            <form  method="post">
                ...
                <table class="table table-hover table-lg table-responsive-sm w-100">
                    ...
                    <th colspan="3" class="text-center"><h2>Main Admin Details </h2></th>
                    </thead>
...
&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="3"><button name="main_admin_update" type="submit" class="btn btn-primary">
