    ...
    <table class="table table-active table-lg table-responsive-sm w-100">
        ...
        <th colspan="3" class="text-center">
              ...
              // $success = "Details has been updated!";
                ...
                <tr>
                    <td><h6>Account Name <i class="fa fa-user fa-fw estate_admin_text"></i></h6></td>
                ...
                <tr>
                    <td><h6>Bank Name <i class="fa fa-bank fa-fw estate_admin_text"></i></h6></td>
                 ...
                 <tr>
                    <td ><button name="create_bank_btn" type="submit" class="btn btn-sm estate_admin_color ">
