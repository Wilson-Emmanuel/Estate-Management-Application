...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
            <?php
            $payments = (new Payment())->fetch_all_payment_estate((new EstateAdmin($_SESSION['id']))->get_estate_id());
            ...
            foreach ($payments as $payment){
                ...
                echo '<td><a href="dashboard.php?tab=payment_details&id='.$payment->get_id().'" title="Click to see full payment details."> <i class="fa fa-eye text-info"> </i> </a> </td>';
                echo '</tr>';
            }
            ?>
