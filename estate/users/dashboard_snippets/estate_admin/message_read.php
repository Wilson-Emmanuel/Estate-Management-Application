        ...
        <div class="col-sm-12">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <span ><?=$message->get_sender_text($message->get_sender()); 
                        if($message->get_sender() =="user"){
                            echo '<br><a href="mailto:'.$message->get_email().'" class="btn btn-sm btn-outline-info"><i class="fa fa-envelope" style="color:yellow;"></i> Reply by email now!</a>';
                        }
                        ?></span>
